...
describe('IconComponent', () => {
  ...
  describe('getSvgPath', () => {
    it('should handle all SVG path scenarios', () => {
      ...
      expect(component.getSvgPath()).toBe(SVG_PATHS['menu'], 'Title type with non-existent name should return menu icon');
    ...
    it('should handle alias with missing path in SVG_PATHS', () => {
      ...
      expect(component.getSvgPath()).toBe(SVG_PATHS['question'], 'Alias to non-existent path should fallback to question');
